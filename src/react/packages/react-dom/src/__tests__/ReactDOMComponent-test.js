  ...
  describe('updateDOM', () => {
    ...
    if (ReactFeatureFlags.enableFilterEmptyStringAttributesDOM) {
      it('should not add an empty src attribute', () => {
        const container = document.createElement('div');
        expect(() => ReactDOM.render(<img src="src/react/packages/react-dom/src/__tests__/ReactDOMComponent-test" />, container)).toErrorDev(
      ...
      it('should not add an empty href attribute', () => {
        const container = document.createElement('div');
        expect(() => ReactDOM.render(<link href="src/react/packages/react-dom/src/__tests__/ReactDOMComponent-test" />, container)).toErrorDev(
      ...
      it('should not add an empty action attribute', () => {
        const container = document.createElement('div');
        expect(() => ReactDOM.render(<form action="src/react/packages/react-dom/src/__tests__/ReactDOMComponent-test" />, container)).toErrorDev(
